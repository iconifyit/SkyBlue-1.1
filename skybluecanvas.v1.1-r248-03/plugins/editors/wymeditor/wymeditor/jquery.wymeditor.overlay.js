...
WYMeditor.INSERT_SNIPPET  = 'Snippet';
WYMeditor.DIALOG_SNIPPET  = 'Snippet';
...
SBC.addbutton(
    WYMeditor.DIALOG_SNIPPET, {
    'href': 'wym/snippets.php', 
    'title': 'Select a Snippet to insert',
    'cmd': WYMeditor.INSERT_SNIPPET,
    'handler': function (wym) {
        SBC.overlay(wym, WYMeditor.DIALOG_SNIPPET);
    }
});
